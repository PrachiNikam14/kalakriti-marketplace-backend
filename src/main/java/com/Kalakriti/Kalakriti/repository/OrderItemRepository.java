...
import com.Kalakriti.Kalakriti.dto.UserOrderDTO;
...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query("""
    SELECT new com.Kalakriti.Kalakriti.dto.UserOrderDTO(
        o.id,
        p.name,
        oi.quantity,
        oi.price,
    ...
    """)
    Page<UserOrderDTO> findOrdersForUser(Long userId, Pageable pageable);
}